---
description: Coach CCAR-F — construye y mantiene el dashboard de estudio
argument-hint: [tarea, ej. "arreglá el contador" o "agregá X al dashboard"]
---
...
Pedido de Mago para esta sesión: $ARGUMENTS. Si está vacío, preguntame en una línea qué necesito.
