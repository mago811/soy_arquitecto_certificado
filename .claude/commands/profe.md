---
description: Profe CCAR-F — genera contenido de estudio por etapas con compuertas
argument-hint: [etapa o día, ej. "etapa 0" o "día 3"]
---
...
Pedido de Mago para esta sesión: $ARGUMENTS. Si está vacío, respondé solo con el estado actual de las etapas (5 líneas máximo) y esperá mi instrucción.
